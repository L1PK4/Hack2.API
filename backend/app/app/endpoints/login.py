...
def authenticate(
    ...
    session = crud.auth_session.create(db=db, obj_in={}, **auth_session_info.dict(), user=user)
    print(session.id)
...
def sign_in(
    ...
    user = crud.crud_user.user.get_by_attrs(db=db, auto_create=True, tel=data.tel)
...
def sign_in(
    ...
    user = crud.crud_user.user.get_by_attrs(db=db, eamil=data.email, auto_create=True)
...
def sign_in(
    ...
    user = crud.crud_user.user.get_by_attrs(db=db, tel=data.tel, auto_create=False)
...
def sign_in(
    ...
    user = crud.crud_user.user.get_by_attrs(db=db, eamil=data.email, auto_create=False)
...
def sign_in(
    ...
    user = crud.crud_user.user.get_by_attrs(db=db, email=data.email, auto_create=False)
...
def sign_in(
    ...
    user = crud.crud_user.user.create(db=db, obj_in={'tel': data.tel, 'password': data.password})
...
def sign_in(
    ...
    user = crud.crud_user.user.create(db=db, obj_in={'email': data.email, 'password': data.password})
